...
U32 addrShort3 = 0x0800C000 + 12 * 16; // 1
U32 addrShort4 = 0x0800C000 + 13 * 16; // 2
U32 addrShort5 = 0x0800C000 + 14 * 16; // 1
U32 addrShort6 = 0x0800C000 + 15 * 16; // 2
void W_Test(void)
{

    System_WriteInteriorFlash(addrShort1, (uint8_t *)&device_state_init.Door_Time, sizeof(device_state_init.Door_Time)); // 存入数据，函数内自动解锁，擦除，写入
//    System_WriteInteriorFlash(addrShort2, (uint8_t *)&device_state_init.pwd_box2, sizeof(device_state_init.pwd_box2)); // 存入数据，函数内自动解锁，擦除，写入
//    System_WriteInteriorFlash(addrShort3, (uint8_t *)&device_state_init.pwd_box3, sizeof(device_state_init.pwd_box3)); // 存入数据，函数内自动解锁，擦除，写入
//		System_WriteInteriorFlash(addrShort4, (uint8_t *)&device_state_init.face_box1, sizeof(device_state_init.face_box1)); // 存入数据，函数内自动解锁，擦除，写入
//    System_WriteInteriorFlash(addrShort5, (uint8_t *)&device_state_init.face_box2, sizeof(device_state_init.face_box2)); // 存入数据，函数内自动解锁，擦除，写入
//    System_WriteInteriorFlash(addrShort6, (uint8_t *)&device_state_init.face_box3, sizeof(device_state_init.face_box3)); // 存入数据，函数内自动解锁，擦除，写入
...
void R_Test(void)
{
		...
		System_ReadInteriorFlash(addrShort1, (uint8_t *)&device_state_init.Door_Time, sizeof(device_state_init.Door_Time)); // 存入数据，函数内自动解锁，擦除，写入
//    System_ReadInteriorFlash(addrShort2, (uint8_t *)&device_state_init.pwd_box2, sizeof(device_state_init.pwd_box2)); // 存入数据，函数内自动解锁，擦除，写入
//    System_ReadInteriorFlash(addrShort3, (uint8_t *)&device_state_init.pwd_box3, sizeof(device_state_init.pwd_box3)); // 存入数据，函数内自动解锁，擦除，写入
//		System_ReadInteriorFlash(addrShort4, (uint8_t *)&device_state_init.face_box1, sizeof(device_state_init.face_box1)); // 存入数据，函数内自动解锁，擦除，写入
//    System_ReadInteriorFlash(addrShort5, (uint8_t *)&device_state_init.face_box2, sizeof(device_state_init.face_box2)); // 存入数据，函数内自动解锁，擦除，写入
//    System_ReadInteriorFlash(addrShort6, (uint8_t *)&device_state_init.face_box3, sizeof(device_state_init.face_box3)); // 存入数据，函数内自动解锁，擦除，写入
